...
?>	
	<div class="image-container">
		...
		<div class="centered">
		<p class="title">TIMIȘOARA<p>
		<p class="below-title">Temeschwar, Temesvár, Темишвар - Mica Vienă</p></div>
	</div>
	<div class="images">
	<div class="image-container">
		<img class="images-homepage" id="img1-home" src="images/img_hp01.jpg">
		<div class="text-block" id="text1-home">
			<h2>Atracții turistice​</h2>
			<p>Timişoara este oraşul cu cel mai mare număr de clădiri istorice din România. 
	...
	<div class="image-container">
		<img class="images-homepage" id="img2-home" src="images/img_hp02.jpg">
		<div class="text-block" id="text2-home">
			<h2>Istorie​</h2>
			<p>Istoria este nisipul care rămâne în clepsidra timpului. Un timișorean știe 
	...
	<div class="image-container">
		<img class="images-homepage" id="img3-home" src="images/img_hp03.jpg">
		<div class="text-block" id="text3-home">
			<h2>Distracție</h2>
	...
	<div class="image-container">
		<img class="images-homepage" id="img4-home" src="images/img_hp04.jpg">
		<div class="text-block" id="text4-home">
			<h2>Campus</h2>
			<p>Se spune că anii de studenție sunt cei mai frumoși ani din viață. 
